...
public class MailUtils {
	...
	public static  void main(String[] args){
		new MailUtils().send("sssssssssssssss");
	}
	public static String emailHost = "smtp.163.com";// 邮件地址

	public static String emailName = "订票通知";// 邮件名

	public static String emailUsername = "lipenghui2018@163.com";// 邮件用户

	public static String emailPassword = "";// 邮件密码

	public static String emailSender = "lipenghui2018@163.com";// 发送者

	public static String emailReceiver = "819059787@qq.com";// 接收者
